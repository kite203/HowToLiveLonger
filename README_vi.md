# Sổ tay sống lâu của Lập trình viên

[![CN doc](https://img.shields.io/badge/文档-中文版-blue.svg)](README.md)
[![EN doc](https://img.shields.io/badge/document-English-blue.svg)](README_en.md)
[![VI doc](https://img.shields.io/badge/Tài&nbsp;Liệu-Tiếng&nbsp;Việt-red.svg)](README_vi.md)
...
- [6. Tham Khảo](#6-Tham-Khảo)
  ...
  - [6.2. Đầu Ra](#62-Đầu-Ra)
    - [6.2.1. Chuyển Động Xoay](#621-Chuyển-Động-Xoay)
    - [6.2.2. Đi Bộ](#622-Đi-Bộ)
    - [6.2.3. Đánh Răng](#623-Đánh-Răng)
    - [6.2.4. Tắm](#624-Tắm)
    - [6.2.5. Làm Việc Nhà（Cho Đàn Ông Lớn Tuổi）](#625-Làm-Việc-Nhà-Cho-Đàn-Ông-Lớn-Tuổi)
    - [6.2.6. Ngủ](#626-Ngủ)
  - [6.3. Bối Cảnh](#63-Bối-Cảnh)
    - [6.3.1. Tâm Trạng](#631-Tâm-Trạng)
    - [6.3.2. Sự Giàu Có](#632-Sự-Giàu-Có)
    - [6.3.3. Trọng Lượng Cơ Thể](#633-Trọng-Lượng-Cơ-Thể)
